...
@onready var tile_button: Button = $Button
...
signal tile_pressed(tile_position: Vector2i, can_move_here: bool, enemy_presence: bool, enemy_index: int)

func _on_button_pressed() -> void:
	emit_signal("tile_pressed", board_position, movable_tile, is_enemy_here, enemy_number)
	

func highlight(color_vector: Color):
	tile_button.self_modulate = color_vector
